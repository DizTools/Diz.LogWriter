...
internal class LogCreatorTempLabelGenerator
{
    ...
    private void GeneratePlusMinusLabels()
    {
        ...
        for (var sourceOffset = 0; sourceOffset < romSize; sourceOffset++)
        {
            ...
            // finally, we only want to consider stuff if there's not already a higher priority label set for the destination
            ...
            if (existingLabel != null)
            {
                ...
                if (existingLabel is TempLabel tempLabel && (tempLabel.Flags & TempLabel.TempLabelFlags.DisallowPlusMinusGeneration) != 0)
    ...
    private void GenerateTempLabelIfNeededAt(int originOffset)
    {
        ...
        var newTempLabel = new TempLabel { Name = labelName };
