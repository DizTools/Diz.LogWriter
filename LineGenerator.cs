...
public class LineGenerator
{
    ...
    public string[] GenerateSpecialLines(string type, int offset = -1) => GenerateLines(
            offset: offset, 
            forceGenerateFullLine: LogCreator.Settings.GenerateFullLine, 
            overrideFormatterName: type 
        );
    
    public string[]  GenerateNormalLines(int offset) => GenerateLines(offset);
    ...
    private string[] GenerateLines(int offset, bool forceGenerateFullLine = true, string overrideFormatterName = null)
    {
